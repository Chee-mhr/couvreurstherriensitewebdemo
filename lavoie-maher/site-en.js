...
(function seal() {
  ...
  function draw(now) {
    ...
    ctx.fillStyle = gold; ctx.font = `600 ${S * .04}px "Bodoni Moda", Georgia, serif`; ctx.fillText("LAW", c, c - S * .075);
...
(function sorter() {
  ...
  function build(r, animate) {
    ...
    label.textContent = "Sorted and renamed"; note.textContent = "mode: " + M.key;
